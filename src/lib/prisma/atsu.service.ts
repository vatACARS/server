...
export class ATSUService {
  ...
  async ATSUInformation(
    ATSUInformationWhereUniqueInput: Prisma.ATSUInformationWhereUniqueInput,
  ): Promise<ATSUInformation | null> {
  ...
  async createATSUInformation(
    data: Prisma.ATSUInformationCreateInput,
  ): Promise<ATSUInformation> {
