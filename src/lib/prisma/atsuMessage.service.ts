...
export class ATSUMessageService {
  ...
  async ATSUMessage(
    ATSUMessageWhereUniqueInput: Prisma.ATSUMessageWhereUniqueInput,
  ): Promise<ATSUMessage | null> {
    return this.prisma.aTSUMessage.findUnique({
      where: ATSUMessageWhereUniqueInput,
    });
  }
  ...
  async createATSUMessage(
    data: Prisma.ATSUMessageCreateInput,
  ): Promise<ATSUMessage> {
